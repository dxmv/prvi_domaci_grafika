...
void rafgl_game_add_game_state(
    rafgl_game_t *game,
    void (*init)(GLFWwindow *window, void *args, int width, int height),
    void (*update)(GLFWwindow *window, float delta_time, rafgl_game_data_t *game_data, void *args),
    void (*render)(GLFWwindow *window, void *args),
...
static GLuint __raster_program = 0;
static GLuint __raster_vao = 0;
...
int rafgl_raster_draw_string(rafgl_raster_t *raster, const char *s, int x, int y, uint32_t colour, int font_size)
{
    ...
    char c;
    int i = 0, index, xt, yt, ox = 0, oy = 0;    while((c = s[i++]) != '\0')
    {
        if(c == '\n')
        {
            ox = -1;
...
void rafgl_game_add_game_state(rafgl_game_t *game, void (*init)(GLFWwindow *window, void *args, int width, int height),void (*update)(GLFWwindow *window, float delta_time, rafgl_game_data_t *game_data, void *args), void (*render)(GLFWwindow *window, void *args),void (*cleanup)(GLFWwindow *window, void *args))
{
...
void rafgl_texture_load_cubemap_named(rafgl_texture_t *tex, const char *cubemap_name, const char *file_ext)
{
    ...
    const char *pcubemap_paths[6] = { &cubemap_paths[0][0], &cubemap_paths[1][0], &cubemap_paths[2][0],
                            &cubemap_paths[3][0], &cubemap_paths[4][0], &cubemap_paths[5][0] };
